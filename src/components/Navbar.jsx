        ...
        <div className="rounded-[999px] border border-[#e8ddd1] bg-white px-4 py-3 shadow-[0_12px_30px_rgba(91,62,44,0.08)] sm:px-6">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="ml-auto flex h-10 w-10 items-center justify-center rounded-full bg-[#f4eee8] text-[#6f5d50] transition hover:bg-[#ede4da] hover:text-[#3f2f24] lg:hidden"
            >
