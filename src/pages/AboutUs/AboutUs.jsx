        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="mt-5 flex items-center gap-4">
              <span className="text-xs font-bold uppercase tracking-widest text-[#2d2822]">
                Follow Me
              </span>
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-[#7a6d62] text-sm leading-relaxed">
              ...
              adventures, I'm delighted to have you here. Let's stir, simmer,
              and savor the beauty of creating something wonderful together.
            </p>
